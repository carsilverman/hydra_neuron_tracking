% HungarianLinkTracker by Carolyn Silverman
%
% Tracks multiple objects in real time based on the 
% hungarianlinker function written by Jean-Yves Tinevez
% and the munkres function written by Yi Cao
...
while(keepRunning)
    ...
    if numberOfBlobs ~= 0 %skip tracking if there are no objects in the field of view
        ...
        if nFrame == 1 || last == 0 %this is the first frame or there were 
            ...
            %Use hungarianlinker to link two sets of centroids. 
            ...
            [target_indices, target_distances, unmatched_targets] = ...
                 hungarianlinker(lastCentroids, centroids);
